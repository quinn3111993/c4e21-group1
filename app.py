...
topic_list = ['amazing', 'attitude', 'beauty', 'best', 'chance', 'change', 'cool', 'courage', 'dreams', 'experience', 'faith', 'forgiveness', 'freedom', 'future', 'god', 'good', 'great', 'happiness', 'hope', 'inspirational', 'knowledge', 'learning', 'life', 'love', 'morning', 'motivational', 'patience', 'peace', 'positive', 'power', 'respect', 'sad', 'smile', 'strength', 'success', 'sympathy', 'thankful', 'time', 'trust', 'truth', 'wisdom']
